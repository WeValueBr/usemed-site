...
export default function Home() {
  return (
    <div >
              ...
              <div class="row">
                <div class="col-lg-3 col-md-3 col-12">
                  <div class="single-achievement wow fadeInUp" data-wow-delay=".2s">
                    <h3 class="counter"><span id="secondo1" class="countup" cup-end="177">177</span></h3>
                    <p>Atendimentos</p>
                  </div>
                </div>
                <div class="col-lg-3 col-md-3 col-12">
                  <div class="single-achievement wow fadeInUp" data-wow-delay=".2s">
                    <h3 class="counter"><span id="secondo1" class="countup" cup-end="56">56</span></h3>
                    <p>Pacientes</p>
                  </div>
                </div>
                <div class="col-lg-3 col-md-3 col-12">
                  <div class="single-achievement wow fadeInUp" data-wow-delay=".4s">
                    <h3 class="counter"><span id="secondo2" class="countup" cup-end="4">4</span></h3>
                    <p>Profissionais</p>
                  </div>
                </div>
                <div class="col-lg-3 col-md-3 col-12">
                  <div class="single-achievement wow fadeInUp" data-wow-delay=".6s">
                    <h3 class="counter"><span id="secondo3" class="countup" cup-end="2">2</span></h3>
                    <p>Clíentes</p>
                  </div>
                </div>
              </div>
      ...
      <section id="clients" class="features section" >
        <div class="container">
          <div className="row">
            <div class="col-lg-3 col-md-3 col-12">
