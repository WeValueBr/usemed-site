                    ...
                    <div class="d-table-cell">
                        <div class="container">
                            <div class="error-content">
                                ...
                                <p>O Usuário Contratante declara, ainda, estar ciente e de acordo com as Políticas de Segurança da Informação e Privacidade e Proteção de Dados Pessoais da USEMED.</p>
                                <p>O pagamento de qualquer indenização eventualmente devido pela USEMED em razão dos serviços disponibilizados, seja por si ou por seus subcontratados, ficará condicionado à comprovação de sua responsabilidade, por sentença judicial transitada em julgado. A reparação será devida na exata medida da culpabilidade no evento lesivo.</p>
                                <p>Caso o Usuário Contratante, independente de culpa, não atender às suas obrigações legais, contratuais e as disposições do presente Termo relacionadas aos Dados Pessoais, o Usuário Contratante deverá: (i) responsabilizar-se, direta ou regressivamente, única e exclusivamente, por todos os prejuízos, indenizações, multas, condenações judiciais ou administrativas ou quaisquer outras despesas oriundas de todos e quaisquer danos causados à USEMED; e (ii) responsabilizar-se por toda e qualquer reclamação, contestação ou divergência que a USEMED venha a ter junto aos titulares de Dados Pessoais, autoridades e/ou terceiros, comprometendo-se, inclusive, a assumir exclusivamente o polo passivo de eventual demanda administrativa ou judicial.</p>
                            </div>
                        </div>
                    </div>
                </div>
